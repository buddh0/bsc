...
var (
	...
	intrinsicContractCreationGas, _ = IntrinsicGas(code, nil, true, true, true, true) //nolint:unused
	...
	intrinsicCodeWithExtCodeCopyGas, _ = IntrinsicGas(codeWithExtCodeCopy, nil, true, true, true, true) //nolint:unused
)

...
func (h Header) MarshalJSON() ([]byte, error) {
	...
	enc.ParentReceiptHash = h.ParentReceiptHash
	enc.ParentBloom = h.ParentBloom
	enc.ParentGasUsed = h.ParentGasUsed
	enc.Hash = h.Hash()
...
func (h *Header) UnmarshalJSON(input []byte) error {
	...
	if dec.ParentReceiptHash != nil {
		h.ParentReceiptHash = dec.ParentReceiptHash
	}
	if dec.ParentBloom != nil {
		h.ParentBloom = dec.ParentBloom
	}
	if dec.ParentGasUsed != nil {
		h.ParentGasUsed = dec.ParentGasUsed
	}
	return nil
}

...
func TestFilters(t *testing.T) {
	...
	filter = sys.NewRangeFilter(900, 999, []common.Address{addr}, [][]common.Hash{{hash3}}, false)
	logs, _ = filter.Logs(context.Background())
	if len(logs) != 1 {
	...
	filter = sys.NewRangeFilter(1, 10, nil, [][]common.Hash{{hash1, hash2}}, false)
	...
	filter = sys.NewRangeFilter(0, -1, nil, [][]common.Hash{{failHash}, {hash1}}, false)
